...
# Structural Attack on subcodes  (0 = y - h.x): (m,n-v,n-k-v,d1,d2), v = \floor((n-k)/(d1+d2)) 
#(q,m,n,k,n1,n2,r1,r2,w)= (2,61,2*67-6,67-6,67-6,67,5,5,2.81) # 128     a1 = 1, a2 = 16,  WF = 207
...
# Shortening and Truncating approach
# (0 = y - h.x): (m,n-v,n-k-v,d1,d2), v = \floor((n-k)/(min(d1,d2))
#(q,m,n,k,n1,n2,r1,r2,w)= (2,61,2*67-13,67-13,67-13,67,5,5,2.81) # 128     a1 = 3, a2 = 7,  WF = 172
...
# Structural attack using the complexity of new 2-LRPC attack
